...
class LMAMPCLearnerSis(object):
    ...
    def model_rollout_for_update(self, start_obses, ite):
        ...
        self.model.set_sis_paras(sis_paras)
    ...
    def forward_and_backward(self, mb_obs, ite):
        with self.tf.GradientTape(persistent=True) as tape:
            obj_loss, punish_terms, cs_loss, pg_loss, constraints, terminal_mu, sis_loss, sis_paras\
        ...
        with self.tf.name_scope('policy_gradient') as scope:
            ...
            k_grad = tape.gradient(sis_loss, self.policy_with_value.sis_para.trainable_weights)
        return pg_grad, mu_grad, k_grad, obj_loss, punish_terms, cs_loss, pg_loss, sis_loss, constraints, terminal_mu, sis_paras
    ...
    def compute_gradient(self, samples, rb, indexs, iteration):
        ...
        with self.grad_timer:
            pg_grad, mu_grad, k_grad, obj_loss, punish_terms, cs_loss, pg_loss, sis_loss, constraints, terminal_mu, sis_paras =\
            ...
            k_grad, k_grad_norm = self.tf.clip_by_global_norm(k_grad, self.args.gradient_clip_norm)
