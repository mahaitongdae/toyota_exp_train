...
class LMAMPCLearner2(object):
    ...
    def model_rollout_for_update(self, start_obses, ite):
        ...
        constraints_max = self.tf.reduce_max(constraints_all, axis=1)
        ...
        cs_sum = self.tf.reduce_sum(self.tf.multiply(mu_all, self.tf.stop_gradient(constraints_max)), 1)
        ...
        return obj_loss, punish_terms, cs_loss, pg_loss, constraints, mu_all
