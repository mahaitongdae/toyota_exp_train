...
from learners.ampc_lag_vector_sis import LMAMPCLearnerSis
from optimizer import OffPolicyAsyncOptimizer, SingleProcessOffPolicyOptimizer
from policy import Policy4Toyota, Policy4Lagrange, Policy4baseline, Policy4LagrangeSis
...
NAME2POLICIES = dict([('Policy4Toyota', Policy4Toyota),
                      ...
                      ('Policy4baseline', Policy4baseline),
                      ('Policy4LagrangeSis', Policy4LagrangeSis)])
...
def built_LMAMPC_parser():
    ...
    # trainer
    parser.add_argument('--policy_type', type=str, default='Policy4LagrangeSis')
    ...
    # env
    parser.add_argument('--env_id', default='Air3d-v0')
    ...
    parser.add_argument('--worker_log_interval', type=int, default=int(10000 / 30))
